  ...
  return (
    <main className="relative min-h-screen overflow-hidden text-slate-100">
      ...
      <div className="absolute inset-0 bg-gradient-to-br 
        from-[#020617] via-[#022c22] to-[#020617]" />

      <div className="absolute -top-32 left-1/2 -translate-x-1/2 
        h-[420px] w-[420px] rounded-full 
        bg-teal-400/25 blur-[160px]" />

      <div className="absolute bottom-[-20%] right-[-10%] 
        h-[520px] w-[520px] rounded-full 
        bg-amber-400/20 blur-[180px]" />

      <section className="relative mx-auto max-w-7xl px-6 py-36 text-center">
        ...
        >
          <Button
            ...
            text-black px-10 py-7 text-lg font-semibold
            shadow-lg hover:shadow-[0_0_40px_rgba(251,191,36,0.6)]
            transition-all"
          >
            Explore Events
          </Button>
          ...
          <Button
            variant="outline"
            className="border-slate-400/60 text-slate-100 
            px-10 py-7 text-lg backdrop-blur-md
        ...
        <motion.p
          ...
          className="mt-16 text-sm md:text-base uppercase 
          tracking-[0.3em] text-slate-400 font-semibold"
        >
