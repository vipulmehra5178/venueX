...
export default function HeroSection() {
  return (
    <main className="relative min-h-screen overflow-hidden text-slate-100">
      <div className="absolute inset-0 bg-linear-to-br from-[#020617] via-[#022c22] to-[#020617]" />
      <div className="absolute -top-32 left-1/2 -translate-x-1/2 h-105 w-105 rounded-full bg-teal-400/25 blur-[160px]" />
      <div className="absolute bottom-[-20%] right-[-10%] h-130 w-130 rounded-full bg-amber-400/20 blur-[180px]" />
      ...
      <section className="relative mx-auto max-w-7xl px-6 pt-38 pb-4 text-center">
        ...
        >
          <Button className="bg-linear-to-r from-amber-400 to-orange-500 text-black px-10 py-7 text-lg font-semibold shadow-lg hover:shadow-[0_0_40px_rgba(251,191,36,0.6)] transition-all">
            Explore Events
          </Button>
        ...
        <motion.div
          ...
          className="mt-6 text-slate-300 text-sm tracking-widest"
        >
          SCROLL TO EXPLORE
